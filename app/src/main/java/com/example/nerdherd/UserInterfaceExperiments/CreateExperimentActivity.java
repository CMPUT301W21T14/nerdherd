...
public class CreateExperimentActivity extends AppCompatActivity implements ExperimentManager.ExperimentCreateEventListener {
    ...
    public void createExperiment(View view) {
        ...
        HashMap<String, Integer> typeMapHack = new HashMap<String, Integer>() {{
            put("Binomial Trial", Experiment.EXPERIMENT_TYPE_BINOMIAL);
            put("Count", Experiment.EXPERIMENT_TYPE_COUNT);
            put("Measurement", Experiment.EXPERIMENT_TYPE_MEASUREMENT);
            put("Non-Negative Integer Count", Experiment.EXPERIMENT_TYPE_NON_NEGATIVE);
        }};
    ...
    @Override
    public void onCreateExperimentSuccess(Experiment createdExperiment) {
        finish();
    }

    @Override
    public void onCreateExperimentFailed(Experiment failedToCreate) {
